...
while($item=mysqli_fetch_assoc($rs)){
	...
	//メール送信
	$StrSQL="SELECT * from DAT_M1 WHERE MID='".$item["ETC03"]."' limit 1";
	...
	echo "未読： ".$item["ID"].": ".$item["NEWDATE"].": MessageFrom-".$item["RID"].": MessageTo-".$item["ETC03"].": CATEGORY-".$item3["CATEGORY"].": EMAIL-".$email1."<br>\n";
