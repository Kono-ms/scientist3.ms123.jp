...
//SELECT, RADIO, CHECKBOX時の値群
  ...
  $FieldParam[2]="";
  $FieldParam[3]="";
  $FieldParam[4]="公開中::非公開";
  $FieldParam[5]="";
  $FieldParam[6]="";
  $FieldParam[7]="";
  $FieldParam[8]="";
  $FieldParam[9]="";
  $FieldParam[10]="対象::非対称";
  $FieldParam[11]="対象::非対称";
  $FieldParam[12]="";
...
function ListSql($sort,$word)
{
	...
	if ($word!=""){
      ...
      " or COMMENT like '%".$word."%' " . 
			...
			// 商談ID仕様変更に対応
      //" or concat('商談ID：', ETC02) like '%".$word."%' " . 
      " or concat('商談ID：', ETC04) like '%".$word."%' " . 
