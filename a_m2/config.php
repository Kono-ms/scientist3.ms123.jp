...
//フィールド名の指定（0番目はオートナンバー型）
  ...
  $FieldName[115]="M2_ETC18"; //アカウント情報（社内メモ）
  $FieldName[116]="M2_ETC19"; //役職
  $FieldName[117]="M2_ETC20"; //組織名（英語表記）
