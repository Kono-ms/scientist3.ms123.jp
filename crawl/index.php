...
<body>
	<div class="container-fluid max-width-c">
		...
		<h4>処理中のプロセス</h4>
		<p class="text-danger">※現在、クローリング依頼により、以下の&nbsp;<span class="mark"><?php echo $cou ?></span>&nbsp;件の処理が実行中です。依頼された処理が多すぎた場合処理が困難になるため注意してください。<br>※リロードすることで進捗状況の表示が更新されます。短い処理は表示されるまえに終了することがあります。</p>
		<?php
		foreach ($process as $key=>$val) {
			...
			echo "<a href='$link' target='_blank'>進捗状況確認：$link</a><br><br>";
		}
		?>
