...
//テーブル名の指定
	$TableName="DAT_AGENCY_SETTING";

//フィールド名の指定（0番目はオートナンバー型）
  $FieldName[0]="ID";
  $FieldName[1]="AS_CURRENCY";
  $FieldName[2]="AS_EXPORT_FEE";
  $FieldName[3]="AS_KEYWORD_CURRENCY";
  $FieldName[4]="ENABLE";
  $FieldName[5]="NEWDATE";
  $FieldName[6]="EDITDATE";
...
//FILE アップロードパス(WEB絶対パス)
	$filepath1="/a_agency_setting/data/";
