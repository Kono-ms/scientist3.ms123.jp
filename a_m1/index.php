...
echo "<!--".$StrSQL."-->";
		...
		$tmp="";
		$sel=explode("::", "サプライヤーID::Company name::First name::Last name::Job title::CEO / Exective Director::Main Phone Number::Banking Details::Billing Address 1::Organization Name::Name::Attention (Optional)::Address Line 1::Address Line 2::City/Province::Zip/Postal Code::Country::Billing Address 2::Organization Name::Name::Attention (Optional)::Address Line 1::Address Line 2::City/Province::Zip/Postal Code::Country::Billing Address 3::Organization Name::Name::Attention (Optional)::Address Line 1::Address Line 2::City/Province::Zip/Postal Code::Country::Banking Details::Currency::Bank name::Account name::Bank branch::Bank address::Account number or IBAN::ABA(Routing) number::SWIFT/BIC code::Intermediary Bank name::Intermediary Bank branch::Intermediary Bank address::適格請求書発行事業者登録番号（Japanese Companies Only）::File::Banking Details::General Accounting Contact::Name::Email::Title::Use different contact information for purchase orders::Remittance Contact::Name::Email::Title::Tax ID::D-U-N-S::Tax forms::Form Type");
		for($i=0; $i<count($sel); $i++){
			$checked="";
