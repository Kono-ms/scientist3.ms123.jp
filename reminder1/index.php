...
function DispData($id,$pass)
{
	...
	if($id!=""){
		...
		$StrSQL="SELECT * from DAT_M1 where EMAIL='".$id."';";
		$rs=mysqli_query(ConnDB(),$StrSQL);
		$item=mysqli_num_rows($rs);
		if($item>0){
			// 時間チェックのため更新日を更新する
			$StrSQL=" UPDATE DAT_M1 SET EDITDATE='".date('Y/m/d H:i:s')."' ";
			...
			$errmsg="<font style='color:#ff0000;'>The entered e-mail address is not registered.</font><br />";
		}
	}
