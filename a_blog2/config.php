...
//SELECT, RADIO, CHECKBOX時の値群
  ...
  $FieldParam[33]="O2_DCHK01-SEL";
  $FieldParam[34]="O2_DCHK02-SEL";
  $FieldParam[35]="O2_DCHK03-SEL";
  $FieldParam[36]="O2_DCHK04-SEL";
  $FieldParam[37]="O2_DCHK05-SEL";
  $FieldParam[38]="O2_DCHK06-SEL";
  $FieldParam[39]="O2_DCHK07-SEL";
  $FieldParam[40]="O2_DCHK08-SEL";
  $FieldParam[41]="O2_DCHK09-SEL";
  $FieldParam[42]="O2_DCHK10-SEL";
...
function ListSQLSearch($sort,$word,$sel1,$sel2)
{
	...
	if ($sel1!=""){
		$str=$str." AND DAT_O1.O2_MSEL01 like '%".$sel1."%'";
	} 

	if ($sel2!=""){
		$str=$str." AND DAT_O1.O2_MSEL02 like '%".$sel2."%'";
	} 
