...
function DispData($mode,$sort,$word,$key,$page,$lid,$token)
{
	...
	// SQLインジェクション対策
	$StrSQL="SELECT DAT_O2.* FROM DAT_O2 inner join DAT_M2 on DAT_M2.MID=DAT_O2.MID inner join DAT_MATCH on DAT_MATCH.OID2=DAT_O2.OID and DAT_MATCH.MID1='".$_SESSION['MID']."' inner join DAT_IINE on DAT_IINE.MIDT=DAT_O2.MID and DAT_IINE.MID='".$_SESSION['MID']."' ";
