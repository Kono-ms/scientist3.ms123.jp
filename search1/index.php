...
function DispData($mode,$sort,$word,$key,$page,$lid,$token,$sel1,$sel2,$word2)
{
	...
	print $str;
		...
		$StrSQL="SELECT DAT_O2.* FROM DAT_O2 inner join DAT_M2 on DAT_M2.MID=DAT_O2.MID and DAT_M2.ENABLE = 'ENABLE:公開中' and DAT_O2.ENABLE = 'ENABLE:公開中' and ".ListSQLSearch($sort,$word,$sel1,$sel2,$word2);
		...
		$str=str_replace("/m_search1/","/search1/",$str);
...
function MakeUrl($sort,$word, $sel1, $sel2,$page)
{
	...
	return "/search1/?mode=list&sort=".urlencode($sort)."&word=".urlencode($word)."&page=".urlencode($page)."&sel1=".urlencode($sel1)."&sel2=".urlencode($sel2);
